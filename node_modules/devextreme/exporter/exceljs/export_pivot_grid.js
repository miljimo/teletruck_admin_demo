...
var _pivot_grid = require("../../ui/pivot_grid");
var _pivot_grid2 = _interopRequireDefault(_pivot_grid);
...
function _getFullOptions(options) {
    ...
    if (!((0, _type.isDefined)(options.component) && (0, _type.isObject)(options.component) && options.component instanceof _pivot_grid2.default)) {
